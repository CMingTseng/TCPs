...
public class TCPClientRunnable2 extends ContentObserver implements Runnable, ObservableInterface {
    ...
    public TCPClientRunnable2(String serverip, int serverport, ContentObserver targetObserver) {
